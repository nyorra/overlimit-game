...
namespace OVERLIMIT.Messages
{
    ...
    public static class AppMessages
    {
        ...
        public static class Loading
        {
            ...
            public static string InputReceived(string sceneName) => $"Получен ввод игрока, переход в {sceneName}";
        ...
        public static class Validation
        {
            ...
            public static string NestedMissing(string parent, string field) => $"Внутри [{parent}] не назначен: {field}";
        }
